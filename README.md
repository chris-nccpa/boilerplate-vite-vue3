...
## Tech Stack based on Vitesse 

As this template is strongly opinionated, it aims to reproduce many of the features of Nuxt with less overhead and dependencies.
...
[Create a repo from this template on GitHub](https://github.com/chris-nccpa/boilerplate-vite-vue3/generate).
...
```bash
npx degit chris-nccpa/boilerplate-vite-vue3 my-vite-app
cd my-vite-app
